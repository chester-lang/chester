...
object TestSumHandler extends Handler[TestSumConstraint] {
  ...
  override def defaulting[M <: SolverModule](constraint: TestSumConstraint, level: DefaultingLevel)(using
      module: M,
      solver: module.Solver[TestSumConstraint]
  ): Boolean = false
}
...
object ProductHandler extends Handler[ProductConstraint] {
  ...
  override def canDefaulting(level: DefaultingLevel): Boolean = false
  override def defaulting[M <: SolverModule](constraint: ProductConstraint, level: DefaultingLevel)(using
      module: M,
      solver: module.Solver[ProductConstraint]
  ): Boolean = false
}
...
object MixedSumHandler extends Handler[MixedConstraint] {
  ...
  override def canDefaulting(level: DefaultingLevel): Boolean = false
  override def defaulting[M <: SolverModule](constraint: MixedConstraint, level: DefaultingLevel)(using
      module: M,
      solver: module.Solver[MixedConstraint]
  ): Boolean = false
}
...
object DefaultingHandler extends Handler[DefaultingConstraint] {
  ...
  override def defaulting[M <: SolverModule](constraint: DefaultingConstraint, level: DefaultingLevel)(using
      module: M,
      solver: module.Solver[DefaultingConstraint]
  ): Boolean = {
