...
Fixpoint subst_ast (x : string) (v : AST) (body : AST) : AST :=
  ...
  | AstVar n val => AstVar n (subst_ast x v val)
  | AstAssign n val => AstAssign n (subst_ast x v val)
  | AstBox e caps => AstBox (subst_ast x v e) caps
  | AstUnbox e => AstUnbox (subst_ast x v e)
  ...
  | AstImport lang alias mod syms => AstImport lang alias mod syms
  | AstMeta m => AstMeta m
